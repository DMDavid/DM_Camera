...
- (void)initNavigationBar
{
    ...
    if(_navigationBar==nil){
        ...
        UIBarButtonItem *leftbutton = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:self action:@selector(pushedFinishBtn:)];
...
- (void)initMenuScrollView
{
    if(self.menuView==nil){
        UIScrollView *menuScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 60)];
    ...
    self.menuView.backgroundColor = [UIColor colorWithRed:235.0/255.0 green:235.0/255.0 blue:235.0/255.0 alpha:1];
}
...
{
    return [CLImageEditorTheme localizedString:@"CLImageEditor_DefaultTitle" withDefault:@"编辑"];
}
...
- (void)swapToolBarWithEditting:(BOOL)editting
{
    ...
    if(self.currentTool){
        UINavigationItem *titleItem  = [[UINavigationItem alloc] initWithTitle:self.currentTool.toolInfo.title];
        UILabel *titleLabel = [[UILabel alloc] init];
        ...
        UIBarButtonItem *rightButton = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStyleDone target:self action:@selector(pushedDoneBtn:)];
        [rightButton setTintColor:[UIColor whiteColor]];
        titleItem.rightBarButtonItem = rightButton;
        NSString *backString = [CLImageEditorTheme localizedString:@"CLImageEditor_BackBtnTitle" withDefault:@"Back"];
        backString = @"取消";
        UIBarButtonItem * leftButton =  [[UIBarButtonItem alloc] initWithTitle:backString style:UIBarButtonItemStylePlain target:self action:@selector(pushedCancelBtn:)];
        [leftButton setTintColor:[UIColor whiteColor]];
        titleItem.leftBarButtonItem  = leftButton;
        
        [_navigationBar pushNavigationItem:titleItem animated:(self.navigationController==nil)];
    }
    else{
